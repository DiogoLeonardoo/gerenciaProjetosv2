...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICACAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTIFICACAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTIFICACAO actions', async () => {
      const arg = { id: 7378 };
    ...
    it('dispatches UPDATE_NOTIFICACAO actions', async () => {
      const arg = { id: 7378 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICACAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTIFICACAO actions', async () => {
      const arg = 42666;
