...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPROMISSO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPROMISSO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPROMISSO actions', async () => {
      const arg = { id: 30278 };
    ...
    it('dispatches UPDATE_COMPROMISSO actions', async () => {
      const arg = { id: 30278 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPROMISSO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPROMISSO actions', async () => {
      const arg = 42666;
