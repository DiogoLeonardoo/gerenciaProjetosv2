...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './etapa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETAPA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETAPA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETAPA actions', async () => {
      const arg = { id: 11181 };
    ...
    it('dispatches UPDATE_ETAPA actions', async () => {
      const arg = { id: 11181 };
    ...
    it('dispatches PARTIAL_UPDATE_ETAPA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ETAPA actions', async () => {
      const arg = 42666;
